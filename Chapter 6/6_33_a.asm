  #у харрисов нерабочий ответ
  #они не сохраняют значение a0 перед вызовом compare, но потом исползуют значение в a0 для проерки условия. В a0 должно быть значение num, а будет 0 или 1.
...
compare:
*  addi sp, sp, -16    #выделение памяти в стеке(в ответах к книге харрисов неправильно память выделяется, по 16 байтам выравниваться фреймы должны)
